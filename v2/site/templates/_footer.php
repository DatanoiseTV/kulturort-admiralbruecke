...
<footer class="fuss">
  <div class="ticker ticker--fuss" aria-hidden="true">
    <div class="ticker__spur">
      <span><?= t('Bis Dienstag — auf der Brücke — bring ein Instrument — oder nur dich — ',
  ...
  <div class="fuss__meta">
    ...
    <span><?= t('D-Jam · dienstags am frühen Abend', 'D-Jam · Tuesdays in the early evening') ?></span>
    <span><?= t('Fotos: D-Jam-Gemeinschaft', 'Photos: the D-Jam community') ?></span>
  </div>
</footer>
